...
| 2026-03-23 | Ejecución completa de retiro legacy (fases 0-4 de `desacople.md`): eliminado runtime `dashboard`/`start_dashboard.py`, limpieza de proxies `v1proxy`, CI/scripts migrados a `api-v1`, documentación archivada en `archive-md-no-canonico/docs/archive/legacy-retired/` y reporte final `archive-md-no-canonico/docs/legacy-removal-report.md`. |
