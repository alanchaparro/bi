...
from app.api.v1.endpoints import admin_analytics, analytics, auth, brokers, health, sync, telemetry
...
router.include_router(admin_analytics.router, prefix='/admin/analytics', tags=['admin-analytics'])
